                                            ...
                                            <ul class="mega-menu clothing-menu">
                                                <li>
                                                    <div class="row m-0">
                                                        ...
                                                        <div class="col-xl-4">
                                                            <a href="#" class="mega-menu-banner"><img src="{{ url('public/assets/images/mega-menu/fashion.jpg') }}" alt="" class="img-fluid blur-up lazyload"></a>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                ...
                                <ul>
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img alt="" class="mr-3" src="{{ url('public/assets/images/fashion/product/1.jpg') }}"></a>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img alt="" class="mr-3" src="{{ url('public/assets/images/fashion/product/2.jpg') }}"></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>item name</h4>
                                                        </a>
